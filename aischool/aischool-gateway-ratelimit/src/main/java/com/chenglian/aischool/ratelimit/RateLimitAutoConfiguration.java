...
package com.chenglian.aischool.ratelimit;
...
import com.chenglian.aischool.ratelimit.config.IUserPrincipal;
import com.chenglian.aischool.ratelimit.config.RateLimiter;
import com.chenglian.aischool.ratelimit.config.properties.RateLimitProperties;
import com.chenglian.aischool.ratelimit.config.repository.InMemoryRateLimiter;
import com.chenglian.aischool.ratelimit.config.repository.RedisRateLimiter;
import com.chenglian.aischool.ratelimit.config.repository.springdata.IRateLimiterRepository;
import com.chenglian.aischool.ratelimit.config.repository.springdata.SpringDataRateLimiter;
import com.chenglian.aischool.ratelimit.filter.RateLimitFilter;

import static com.chenglian.aischool.ratelimit.config.properties.RateLimitProperties.PREFIX;
